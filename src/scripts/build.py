...
def build():
    ...
    routes = [('about','/about/','about_title','about_desc'),('legal','/legal/','legal_title','legal_desc'),('imprint','/legal/imprint/','imprint_title','imprint_desc'),('privacy','/legal/privacy/','privacy_title','privacy_desc'),('terms','/legal/terms/','terms_title','terms_desc'),('cookies','/legal/cookies/','cookies_title','cookies_desc'),('support','/Support/','support_title','support_desc'),('apps','/apps/','apps_title','apps_desc'),('contact','/contact/','contact_title','contact_desc'),('send-confirmation','/send-confirmation/','confirmation_title','confirmation_desc'),('request-confirmation','/request-confirmation/','request_confirmation_title','request_confirmation_desc'),('newsletter-confirmation','/newsletter-confirmation/','newsletter_confirmation_title','newsletter_confirmation_desc'),('kanboa','/kanboa/','kanboa_title','kanboa_desc'),('kanboa-project','/kanboa-project/','kanboa_project_title','kanboa_project_desc')]
    for lang in ('en','de'):
