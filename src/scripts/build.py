...
def support_page_html(project, articles, copy, lang):
    ...
    if lang == 'de':
        intro = f'<section class="support-hero product-hero" aria-labelledby="support-product-title">{icon(project)}<p class="product-label">{escape(project["name"])}</p><h1 id="support-product-title">Hilfe und Antworten</h1><label class="support-search"><span>Fragen durchsuchen</span><input type="search" data-support-search placeholder="Fragen durchsuchen" autocomplete="off"></label></section>'
        ...
        intro = f'<section class="support-hero product-hero" aria-labelledby="support-product-title">{icon(project)}<p class="product-label">{escape(project["name"])}</p><h1 id="support-product-title">Help and answers</h1><label class="support-search"><span>Search questions</span><input type="search" data-support-search placeholder="Search questions" autocomplete="off"></label></section>'
